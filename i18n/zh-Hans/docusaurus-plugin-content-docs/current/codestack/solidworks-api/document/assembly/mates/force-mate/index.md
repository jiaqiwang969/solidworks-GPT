...
caption: 运行力学配对命令
description: 该示例演示了如何使用SOLIDWORKS API和Windows API的组合来运行带有重建错误的配对的“Force Mate”命令。
image: force-mate.png
---
![上下文菜单中的Force Mate命令](force-mate.png){ width=350 }

该示例演示了如何运行“Force Mate”命令以解决带有重建错误的配对的约束。此宏基于Windows和SOLIDWORKS API的组合。
