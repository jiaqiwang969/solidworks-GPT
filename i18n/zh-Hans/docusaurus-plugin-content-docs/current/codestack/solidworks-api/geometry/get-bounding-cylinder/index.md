---
title: 使用SOLIDWORKS API查找实体的边界圆柱体
caption: 获取实体边界圆柱体
description: 本示例演示如何使用SOLIDWORKS API获取实体的边界圆柱体。
image: cylindrical-bounding-box.png
---
![在实体周围创建圆柱体边界框](cylindrical-bounding-box.png){ width=400 }

本示例演示如何使用SOLIDWORKS API查找实体的边界圆柱体。
...
namespace CodeStack
{
    public partial class SolidWorksMacro
    {
        ...
        private IBody2 GetBodyToProcess(IPartDoc part, object inputObj)
        {
            ...
            throw new NullReferenceException("无法找到输入实体。请选择圆柱面或使用单个实体零件");
        }
