---
caption: 翻转最后一个装配体中插入的配合关系的对齐方式
title: 在SOLIDWORKS装配体中翻转最后一个插入的配合关系的对齐方式的宏
description: 这是一个VBA宏，用于在SOLIDWORKS装配体特征管理器树中查找最后一个配合关系。

对于这个配合关系，将其对齐方式从反对齐切换到对齐，反之亦然。
