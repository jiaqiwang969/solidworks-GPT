...
![通过运行宏按钮中的宏递增标题块中的修订版](increment-revision-macro.gif)
...
* 需要向注释添加文本标签以递增其值。请按照[向选定的注释添加标签](/docs/codestack/solidworks-api/document/notes/tag-selected-note)示例中的说明添加标签到注释。
