...
---
 VBA macro that collects the output files (e.g., DXF, PDF) of all referenced parts and sub-assemblies documents and copies them into a specified folder from all the folders
