...
[ComStorage.cs](https://github.com/teknowledgist/solidworks-api/blob/master/ThirdPartyStorage/ComStorage.cs)是对[IStorage](https://docs.microsoft.com/en-us/windows/desktop/api/objidl/nn-objidl-istorage)接口的封装，简化了从.NET语言访问的过程。
...
[ComStream.cs](https://github.com/teknowledgist/solidworks-api/blob/master/ThirdPartyStorage/ComStream.cs)是对[IStream](https://docs.microsoft.com/en-us/windows/desktop/api/objidl/nn-objidl-istream)接口的封装，简化了从.NET语言访问的过程。
