...
caption: 组件配置排列
description: 该宏使用SOLIDWORKS API对装配体的根级组件进行排列组合，并将结果保存为单独的文件。
...
![每个组件配置组合生成的装配体](generated-permutation-assemblies.png){ width=350 }
...
* *PERMUTE_ASSEMBLY_CONF* 选项允许指定是否在排列组合中使用装配体的配置，还是仅使用组件的配置
