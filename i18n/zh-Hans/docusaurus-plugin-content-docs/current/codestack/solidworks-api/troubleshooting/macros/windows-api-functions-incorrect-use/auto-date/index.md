...
description: 这个VBA宏允许将自定义属性**日期**插入到文件特定的自定义属性中。用户可以选择日期的格式。有关支持的格式的更多信息，请参阅[日期和时间格式字符串](https://docs.microsoft.com/en-us/dotnet/standard/base-types/standard-date-and-time-format-strings)。
image: auto-date-custom-property.svg
group: 自定义属性
---

这个VBA宏允许将自定义属性**日期**插入到文件特定的自定义属性中。用户可以选择日期的格式。有关支持的格式的更多信息，请参阅[日期和时间格式字符串](https://docs.microsoft.com/en-us/dotnet/standard/base-types/standard-date-and-time-format-strings)。
