...
group: Sketch
---
![将草图合并为3D草图](merged-3dsketch.png)
...
* *NEW_SKETCH_NAME* - 新生成的合并草图的名称，空字符串表示使用默认的自动生成的名称
...
与[按类型选择功能](/docs/codestack/solidworks-api/document/selection/select-features-by-type/)一起使用此宏，以选择要合并的所有草图。
