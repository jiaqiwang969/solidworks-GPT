...
~~~ vb
Const OUT_FILE_PATH_TEMPLATE As String = "<_FileName_>-<_TableName_>.csv" '保存在模型文件夹中的空字符串
...
例如，以下参数将将BOM表导出为CSV格式，保存在D驱动器的**Tables**文件夹中，文件名为源表格的名称。
