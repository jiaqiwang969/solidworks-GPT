...
description: 该宏使用SOLIDWORKS API，通过从图形区域或特征树中选择的实体，将其从焊接或钣金切割清单中排除。
...
该宏允许使用SOLIDWORKS API从焊接或钣金切割清单中排除所选实体。

可以在图形视图或特征树中选择实体，这样可以更轻松地完成该过程，因为不需要找到相应的切割清单特征来排除实体。
