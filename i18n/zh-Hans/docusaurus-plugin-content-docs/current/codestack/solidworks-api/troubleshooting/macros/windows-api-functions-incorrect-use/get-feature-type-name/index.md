...
caption: 获取特征类型名称
---
 使用SOLIDWORKS API获取所选特征的类型名称的VBA宏，并在消息框中显示结果
...
其中，*类型名称1* 是通过[SOLIDWORKS API](https://help.solidworks.com/2016/english/api/sldworksapi/solidworks.interop.sldworks~solidworks.interop.sldworks.ifeature~gettypename.html)中的[IFeature::GetTypeName](https://help.solidworks.com/2016/english/api/sldworksapi/solidworks.interop.sldworks~solidworks.interop.sldworks.ifeature~gettypename.html)方法检索到的旧版本特征类型名称，而*类型名称2*是通过[IFeature::GetTypeName2](https://help.solidworks.com/2016/english/api/sldworksapi/solidworks.interop.sldworks~solidworks.interop.sldworks.ifeature~gettypename2.html)方法检索到的新版本特征类型名称。
