...
Set swFeat = GetFirstFeature(swModel, "WeldMemberFeat") '返回WeldMemberFeat类型（即结构成员）的第一个特征
~~~
...
vFeats = GetAllFeatures(swModel, "WeldMemberFeat") '返回WeldMemberFeat类型（即结构成员）的所有特征
~~~
