...
注意，这种方法是渲染OpenGL对象的简单方法，但它并不提供最佳性能。请参考[导入XAML文件并使用VBO进行渲染](/docs/codestack/solidworks-api/adornment/opengl/vbo-xaml-importer/)以获取使用OpenGL顶点缓冲对象（VBO）进行高性能图形渲染的代码示例。
