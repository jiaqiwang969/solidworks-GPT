...
可以使用[SOLIDWORKS API](https://help.solidworks.com/2016/english/api/sldworksapi/solidworks.interop.sldworks~solidworks.interop.sldworks.ibody2~getmassproperties.html)方法`IBody2::GetMassProperties`来找到特定物体的质量，但是需要指定密度才能计算质量，这可能不容易提取。
...
以下是使用SOLIDWORKS API获取选定绘图视图中所有物体的质量并在消息框中显示结果的C# VSTA宏代码。
