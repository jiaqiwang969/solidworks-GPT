...
这个VBA宏可以根据几何尺寸和指定的匹配映射自动缩放当前工作表中的绘图视图。

映射是一组指令，用于定义：

* 几何体的最小和最大宽度。使用 * 来匹配任何值
* 几何体的最小和最大高度。使用 * 来匹配任何值
* 如果匹配，则缩放的分子和分母
...
* 所有宽度不超过100毫米且任何高度的绘图视图将设置为1:1的比例
* 所有宽度在100毫米到200毫米之间且高度在50毫米到100毫米之间的绘图视图将设置为1:2的比例
