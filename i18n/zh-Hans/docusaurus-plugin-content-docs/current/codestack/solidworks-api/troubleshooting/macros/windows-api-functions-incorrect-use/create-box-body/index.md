...
caption: 创建盒子实体
description: 使用 SOLIDWORKS API 和 IModeler 接口，通过提供基准面中心坐标、方向、宽度、长度和高度来创建和显示临时实体盒子的 VBA 示例
image: box-body.png
labels: [primitive,box,temp body,modeler]
---
![盒子实体](box-body.png){ width=250 }

此 VBA 示例演示了如何使用 SOLIDWORKS API 创建和显示临时实体盒子。通过提供基准面中心坐标、方向、宽度、长度和高度来创建盒子。
