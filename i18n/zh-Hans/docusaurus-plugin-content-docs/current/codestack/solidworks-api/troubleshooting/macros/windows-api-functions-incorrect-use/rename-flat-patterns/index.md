...
group: Part
---
![切割清单和钣金展开图](renamed-flat-patterns.png){ width=250 }

此 VBA 宏将所有钣金展开特征重命名为相应的切割清单项名称。

此宏可与 [重命名切割清单特征](/docs/codestack/solidworks-api/document/cut-lists/rename-cut-list-items/) 宏一起使用。

为避免名称冲突，将后缀添加到钣金展开特征中，如下所示。

~~~ vb jagged-bottom
Const SUFFIX As String = "_FP"
~~~

如果具有相同切割清单的钣金展开图案，宏将自动向展开图案名称添加索引。
