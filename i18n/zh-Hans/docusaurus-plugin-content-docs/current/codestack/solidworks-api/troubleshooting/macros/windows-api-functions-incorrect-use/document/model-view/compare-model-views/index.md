...
caption: 比较模型视图
description: 该示例演示了如何使用SOLIDWORKS API比较零件或装配中的两个模型视图（通过方向、平移和缩放）
...
宏使用[用户定义类型](/docs/codestack/visual-basic/data-structures/types/) **ViewData** 存储视图的方向、平移和缩放。该结构与视图没有关联，表示视图变换的快照。
