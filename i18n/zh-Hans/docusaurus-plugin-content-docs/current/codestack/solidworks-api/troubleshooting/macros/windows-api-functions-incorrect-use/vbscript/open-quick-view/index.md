...
SOLIDWORKS提供了一种在[大型设计审查](https://help.solidworks.com/2018/English/SolidWorks/sldworks/HIDD_DIALOG_LDR_WARNING.htm)模式（也称为快速查看）下打开大型装配或绘图的选项。这样可以仅加载装配和绘图的视觉信息，显著提高性能（大型装配通常在几秒钟内打开，而不是几分钟甚至几小时）。可以随后按需加载各个组件。
